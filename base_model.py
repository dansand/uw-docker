...
figStrainRate.append( glucifer.objects.Surface(elementMesh, secinvCopy, logScale=True))
...
figDb.append( glucifer.objects.Surface(elementMesh, secinvCopy, logScale=True, colours='brown white blue'))
...
figVelocityMag = glucifer.Figure()
figVelocityMag.append( glucifer.objects.Surface(elementMesh, fn.math.dot(velocityField,velocityField)))
figVelocityMag.append( glucifer.objects.VectorArrows(elementMesh,velocityField, arrowHead=0.2, scaling=0.001))
figVelocityMag.show()
